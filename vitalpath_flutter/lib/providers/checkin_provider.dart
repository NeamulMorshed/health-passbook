...
class CheckinNotifier extends StateNotifier<CheckinState> {
  ...
  Future<void> _load() async {
    ...
    state = CheckinState(isCheckedInToday: done, sleepQuality: sleep, feeling: feeling);
  }

  Future<void> checkIn({required String sleepQuality, required String feeling}) async {
    final prefs = await SharedPreferences.getInstance();
    ...
    state = CheckinState(isCheckedInToday: true, sleepQuality: sleepQuality, feeling: feeling);
  }
}
