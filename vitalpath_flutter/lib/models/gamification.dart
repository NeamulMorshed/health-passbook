...
final List<BadgeDefinition> kAllBadges = [
  ...
  BadgeDefinition(id: 'active_first', name: 'First Steps',     description: 'Logged your first activity',         icon: (c) => Icon(Icons.directions_walk_rounded,         color: c, size: 28), color: AppColors.caregiver),
  ...
  BadgeDefinition(id: 'activity_5',   name: 'Stay Active',     description: '5-day activity streak',              icon: (c) => Icon(Icons.fitness_center_rounded,          color: c, size: 28), color: AppColors.caregiver),
  BadgeDefinition(id: 'hp_500',       name: 'Centurion',       description: 'Reached 500 Health Points',          icon: (c) => Icon(Icons.military_tech_rounded,           color: c, size: 28), color: AppColors.caregiver),
