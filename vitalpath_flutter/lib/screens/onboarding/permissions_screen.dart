...
class _PermissionsScreenState extends State<PermissionsScreen> {
  ...
  final _perms = [
    _PermData(
      ...
      subtitle:
          'Track your walks and outdoor activities with GPS for accurate distance measurement.',
    ...
    _PermData(
      ...
      title: 'Camera & Photos',
      subtitle:
          'Take photos of your meals and prescriptions to keep detailed health records.',
    ...
    _PermData(
      ...
      subtitle:
          'Get notified when it\'s time to take your medicine. Never miss a dose again.',
            ...
            children: [
              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  Expanded(
                      child: Text(data.why,
                          style: TextStyle(fontSize: 13, color: data.color))),
                ]),
              ),
              const Spacer(),
              GradientButton(
                  label: 'Allow ${data.title}',
