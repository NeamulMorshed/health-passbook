                ...
                child: Column(children: [
                  ...
                  patientAsync.when(
                    ...
                    error: (_, __) => Padding(
                      ...
                      child: Column(children: [
                        const Text('Failed to load health info',
                            style: TextStyle(color: AppColors.mutedForeground)),
                        TextButton(
                            onPressed: () => ref
                                .invalidate(patientProfileProvider(user.uid)),
                        ...
                        BentoCard(
                          child: Column(
                              ...
                              children: [
                                if (patient.bmi != null)
                                  _InfoRow('BMI',
                                      '${patient.bmi!.toStringAsFixed(1)} (${_bmiLabel(patient.bmi!)})'),
